...
function spawnDoors(){
 ...
 if (frameCount % 240 === 0) {
  ...
  //atribuir o tempo de vida ao obstacle.lifetime = 300; aqui os obstáculos são as portas, o escalador e o bloco invisível
  door.lifetime = 800;
